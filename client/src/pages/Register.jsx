    ...
    <div className="pt-28 pb-20 min-h-screen bg-cream/30 flex items-center justify-center px-6">
      <div className="bg-white rounded-3xl p-8 md:p-12 shadow-premium border border-dark-green/5 max-w-md w-full flex flex-col gap-6">
        ...
        <div className="text-center flex flex-col gap-2">
          ...
          <h1 className="text-3xl font-bold font-heading text-dark-text">Join Wellness</h1>
          <p className="text-xs text-gray-500 font-light">Create an account for personalized wellness recommendations</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-cream/40 border border-dark-green/10 rounded-xl py-2 pl-10 pr-4 text-sm focus:outline-none focus:border-dark-green text-dark-text"
              />
              <FaEnvelope className="absolute left-3.5 top-3 text-gray-400" size={12} />
            </div>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-dark-green hover:bg-light-green text-cream py-2.5 rounded-full font-bold transition shadow-md disabled:bg-gray-300 disabled:text-gray-500 mt-2"
          >
        ...
        <p className="text-xs text-gray-500 text-center font-light mt-2">
          ...
          <Link to="/login" className="text-dark-green font-bold hover:underline">
            Sign In
          </Link>
        </p>
